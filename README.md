...
The TypeScript API contract is generated from `openapi.json`. It is regenerated
automatically before every build, or can be updated directly with:
...
file matches the OpenAPI document.
